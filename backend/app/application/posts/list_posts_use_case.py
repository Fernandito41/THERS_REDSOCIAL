...
#
# viewer_id + like_repository (ADR-005-likes-minimal-model.md) y
# comment_repository (ADR-006-comments-minimal-model.md): los resúmenes de
# likes/comentarios se resuelven con consultas agregadas sobre todos los
# posts de la página, no una por post -- evita el N+1 que tendría preguntar
# "¿cuántos likes/comentarios tiene?"/"¿lo likeé?" post por post.
...
def list_posts(post_repository, like_repository, comment_repository, viewer_id, limit=DEFAULT_LIMIT):
